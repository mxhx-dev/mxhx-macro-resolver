...
In a macro context, and using a document tree generated by [mxhx-xml-parser](https://github.com/mxhx-dev/mxhx-xml-parser), resolves the symbols that the XML tags, attributes, and text represent.
